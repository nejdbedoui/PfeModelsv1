...
public class PointVente {
    ...
    private Short sendRCToGer;
    private Short fAfficheMob;
    private String ImagePV;
    private Double mntMin;
    private String nTel;
	...
	public Short getSendRCToGer() {
		return sendRCToGer;
	}

	public void setSendRCToGer(Short sendRCToGer) {
		this.sendRCToGer = sendRCToGer;
	}

	public Short getfAfficheMob() {
		return fAfficheMob;
	}
	...
	public void setfAfficheMob(Short fAfficheMob) {
		this.fAfficheMob = fAfficheMob;
	}
	...
	public void setMntMin(Double mntMin) {
		this.mntMin = mntMin;
	}
